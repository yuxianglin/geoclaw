!$Id: init_obs_pdaf.F90 1443 2013-10-04 10:52:09Z lnerger $
!BOP
!
...
! !ARGUMENTS:
  ...
  INTEGER, INTENT(in) :: dim_obs_f        ! PE-local dimension of obs. vector
  REAL, INTENT(out)   :: observation_f(dim_obs_f) ! PE-local observation vector
