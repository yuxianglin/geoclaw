!$Id: nullmpi.F90 1532 2014-12-17 14:04:59Z lnerger $
!BOP
!
...
SUBROUTINE MPI_Isend(field, dim, datatype, pe_dest, pe_target, &
     comm, request, mpierr)
...
! ------------------------------------------------------------------------------
SUBROUTINE MPI_Waitall(nrequests, requests, statuses, mpierr)
