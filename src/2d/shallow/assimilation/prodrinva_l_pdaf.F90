!$Id: prodrinva_l_pdaf.F90 1443 2013-10-04 10:52:09Z lnerger $
!BOP
!
...
! !USES:
  USE mod_assimilation, &
       ...
       obs_index_l, coords_obs, coords_l,coords_l_1d,coords_l_2d
#if defined (_OPENMP)
  USE omp_lib, &
...
! call oned_to_twod(coords_l_1d,2,2,coords_l_2d)
 call ind1d_to_coord2d(coords_l_1d,coords_l_2d)
  init_distance: DO i = 1, dim_obs_l
     ...
     distance(i) = SQRT(REAL((coords_l_2d(1) - coords_obs(1, obs_index_l(i)))**2 + &
          (coords_l_2d(2) - coords_obs(2, obs_index_l(i)))**2))
