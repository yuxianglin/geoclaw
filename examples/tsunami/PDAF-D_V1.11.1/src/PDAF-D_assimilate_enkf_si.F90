...
!
!$Id: PDAF-D_assimilate_enkf_si.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_enkf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_assimilate_enkf_si(outflag)
