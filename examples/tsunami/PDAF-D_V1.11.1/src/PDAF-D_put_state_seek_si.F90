...
!
!$Id: PDAF-D_put_state_seek_si.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_seek_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_seek_si(outflag)
...
! ! Names of external subroutines 
  EXTERNAL :: collect_state_pdaf, & ! Routine to collect a state vector
       ...
       prepoststep_pdaf, &          ! User supplied pre/poststep routine for SEEK
       prodRinvA_pdaf               ! Provide product R^-1 HV
...
! **************************************************
  ...
  CALL PDAF_put_state_seek(collect_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, &
       init_obs_pdaf, prepoststep_pdaf, prodRinvA_pdaf, outflag)
