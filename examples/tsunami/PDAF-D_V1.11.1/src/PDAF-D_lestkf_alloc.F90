...
!
!$Id: PDAF-D_lestkf_alloc.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_lestkf_alloc --- PDAF-internal initialization of LESTKF
!
! !INTERFACE:
SUBROUTINE PDAF_lestkf_alloc(subtype, outflag)
...
!
! !REVISION HISTORY:
! 2011-09 - Lars Nerger - Initial code based on LSEIK
