...
!
!$Id: PDAF-D_lseik_memtime.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
...
! *********************************************
     ...
     IF (subtype_filter /= 4) THEN
        WRITE (*, '(a, 17x, a, F11.3, 1x, a)') 'PDAF', 'ensemble transformation (8):', pdaf_time_tot(8), 's'
     END IF
...
! *****************************************
     ...
     IF (subtype_filter /= 4) THEN
        WRITE (*, '(a, 29x, a, F11.3, 1x, a)') 'PDAF', 'update state (14):', pdaf_time_tot(14), 's'
        WRITE (*, '(a, 17x, a, F11.3, 1x, a)') 'PDAF', 'ensemble transformation (8):', pdaf_time_tot(8), 's'
     END IF
