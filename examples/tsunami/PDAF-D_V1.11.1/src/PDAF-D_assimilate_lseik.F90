...
!
!$Id: PDAF-D_assimilate_lseik.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_lseik --- Interface to PDAF for LSEIK
!
! !INTERFACE:
...
! is computed by calling PDAF_put_state_lseik. Subsequently, 
