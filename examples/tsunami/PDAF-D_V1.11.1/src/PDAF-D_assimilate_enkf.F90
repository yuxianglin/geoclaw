...
!
!$Id: PDAF-D_assimilate_enkf.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_enkf --- Interface to PDAF for EnKF
!
! !INTERFACE:
...
! is computed by calling PDAF_put_state_enkf. Subsequently, 
...
! ********************************
  ...
  IF (cnt_steps == nsteps_pdaf) THEN
     ...
     CALL PDAF_put_state_enkf(U_collect_state, U_init_dim_obs, U_obs_op, &
          U_init_obs, U_prepoststep, U_add_obs_error, U_init_obs_covar, outflag)
