...
!
!$Id: PDAF-D_etkf_alloc.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_etkf_alloc --- PDAF-internal initialization of ETKF
!
! !INTERFACE:
SUBROUTINE PDAF_etkf_alloc(subtype, outflag)
...
! ******************************
  ...
  on_filterpe: IF (filterpe) THEN
     ...
     IF (screen > 2) WRITE (*,*) 'PDAF: etkf_alloc - allocate eofV of size ', &
