...
!
!$Id: PDAF-D_assimilate_estkf.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_estkf --- Interface to PDAF for ESTKF
!
! !INTERFACE:
...
! is computed by calling PDAF_put_state_estkf. Subsequently, 
