...
!
!$Id: PDAF-D_put_state_estkf_si.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_estkf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_estkf_si(outflag)
