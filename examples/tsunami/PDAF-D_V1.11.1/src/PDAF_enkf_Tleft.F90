...
!
!$Id: PDAF_enkf_Tleft.F90 1561 2015-02-22 15:57:23Z lnerger $
!BOP
!
! !ROUTINE: PDAF_enkf_Tleft --- Operate matrix T from left to some matrix
!
! !INTERFACE:
SUBROUTINE PDAF_enkf_Tleft(dim_ens, dim, A)
...
END SUBROUTINE PDAF_enkf_Tleft
