...
! !USES:
  ...
  USE mod_parallel_pdaf, &     ! Parallelization variables fro assimilation
       ...
       mype_world, COMM_model, abort_parallel
...
! ***************************
  ...
  ! *** Define state dimension ***
    !dim_state_p = nx*ny  ! Local state dimension
    dim_state_p = 10  ! Local state dimension
!   dim_state = ...      ! Global state dimension
  WRITE (*,*) 'TEMPLATE init_pdaf.F90: Set state dimension here!'
